...
def plot_price(info: SimulatorInfo, spread=False, rolling: int = 1, figsize=(6, 6), save_path=None):
...
def plot_arbitrage(info: SimulatorInfo, access: int = 1, rolling: int = 1, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
    if rolling == 1:
...
def plot_dividend(info: SimulatorInfo, rolling: int = 1, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
...
def plot_orders(info: SimulatorInfo, stat: str = 'quantity', rolling: int = 1, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
...
def plot_volatility_price(info: SimulatorInfo, window: int = 5, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
...
def plot_volatility_return(info: SimulatorInfo, window: int = 5, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
...
def plot_liquidity(info: SimulatorInfo, rolling: int = 1, figsize=(6, 6), save_path=None):
    plt.figure(figsize=figsize)
